...
class MobilePageLog extends StatefulWidget {
  const MobilePageLog({super.key});

  @override
  State<MobilePageLog> createState() => _MobilePageLogState();
}

class _MobilePageLogState extends State<MobilePageLog> {
  ...
  IconData getActionIcon(String action) {
    if (action.toLowerCase().contains('menambah') ||
        action.toLowerCase().contains('tambah')) return Icons.add_circle;
    if (action.toLowerCase().contains('mengubah') ||
        action.toLowerCase().contains('ubah') ||
        action.toLowerCase().contains('edit') ||
        action.toLowerCase().contains('update')) return Icons.edit;
    if (action.toLowerCase().contains('menolak') ||
        action.toLowerCase().contains('tolak') ||
        action.toLowerCase().contains('reject')) return Icons.cancel;
    if (action.toLowerCase().contains('menyetujui') ||
        action.toLowerCase().contains('setuju') ||
        action.toLowerCase().contains('approve')) return Icons.check_circle;
    if (action.toLowerCase().contains('mengajukan') ||
        action.toLowerCase().contains('ajukan') ||
        action.toLowerCase().contains('submit')) return Icons.send;
    if (action.toLowerCase().contains('check in') ||
        action.toLowerCase().contains('checkin')) return Icons.login;
    if (action.toLowerCase().contains('check out') ||
        action.toLowerCase().contains('checkout')) return Icons.logout;
    if (action.toLowerCase().contains('upload') ||
        action.toLowerCase().contains('lampiran')) return Icons.attach_file;
    if (action.toLowerCase().contains('hapus') ||
        action.toLowerCase().contains('delete')) return Icons.delete;
    return Icons.info;
  }
