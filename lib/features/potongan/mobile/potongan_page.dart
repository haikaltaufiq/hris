...
class PotonganMobile extends StatefulWidget {
  const PotonganMobile({super.key});

  @override
  State<PotonganMobile> createState() => _PotonganMobileState();
}

class _PotonganMobileState extends State<PotonganMobile> {
              ...
              child: FloatingActionButton(
                onPressed: () {
                  Navigator.of(context).push(
                    MaterialPageRoute(
                        builder: (context) => const PotonganForm()),
                  );
                },
