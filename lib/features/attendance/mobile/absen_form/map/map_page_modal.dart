...
class MapPageModal extends StatefulWidget {
  final LatLng target;

  const MapPageModal({super.key, required this.target});

  @override
  State<MapPageModal> createState() => _MapPageModalState();
}

class _MapPageModalState extends State<MapPageModal>
